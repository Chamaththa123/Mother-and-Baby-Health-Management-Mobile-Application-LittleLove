      ...
      ListFooterComponent={() => (
        <>
          ...
          <View style={styles.row2}>
            <TouchableOpacity style={styles.menucard} onPress={() => navigation.navigate('AddMother')}>
              <Text style={styles.cardText}>Create Mother Profile</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.menucard} onPress={() => navigation.navigate('MotherList')}>
